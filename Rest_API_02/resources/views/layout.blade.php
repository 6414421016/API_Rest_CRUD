        ...
        <div class="container flex justify-between h-16 mx-auto">
            <div class="flex">
                ...
                <ul class="items-stretch hidden space-x-3 lg:flex">
                    <li class="flex">
                        <a rel="noopener noreferrer" href="{{route('fetchdata')}}"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-">Post</a>
                    </li>
                    <li class="flex">
                        <a rel="noopener noreferrer" href="#"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-">Link</a>
                    </li>
                    <li class="flex">
                        <a rel="noopener noreferrer" href="#"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-">Link</a>
            ...
            {{-- <div class="items-center flex-shrink-0 hidden lg:flex">
                <button class="px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50">Log in</button>
            </div> --}}
